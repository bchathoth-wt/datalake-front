...
import Platform from "layouts/dashboards/platform";
...
import SignUpCover from "layouts/authentication/sign-up/basic";
...
// Images
import profilePicture from "assets/images/bijeesh-profile-pics.jpg";

const routes = [
  {
    type: "collapse",
    name: "Bijeesh Chathoth",
    key: "bijeesh-chathoth",
    icon: <MDAvatar src={profilePicture} alt="Bijeesh Chathoth" size="sm" />,
    collapse: [
      {
        name: "Settings",
  ...
  { type: "title", title: "Examples", key: "title-examples" },
  {
    type: "collapse",
    name: "Components",
    key: "components",
